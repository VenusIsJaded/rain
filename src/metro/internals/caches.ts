...
// extractExportsFlags and indexExportsFlags removed:
// extractExportsFlags always returned ModuleFlags.EXISTS, which indexExportsFlags
// then immediately filtered out (flags !== ModuleFlags.EXISTS was always false),
// making both functions unconditional no-ops. Dead code.
